/*
 * FileName: SnakesAndLadders.java
 * @Author: Rohan Dalvi
 * @Author: Ajay Pantangi
 * 
...
import java.applet.*;
/*
 * The following class demonstrates a game of Snakes and Ladders.
 * This class has the following methods:
 * 
 * 1. void init(): This method is called when running the applet.
 * 
 * 2.void paint(Graphics g): This method is responsible for rendering graphics for the game.
 * 
 * 3.void current_score(int i,int turn): This method is responsible for maintaining current score of each player and making decisions based on each player's score.
 */
public class SnakesAndLadders extends Applet implements ActionListener{
    ...
    public void current_score(int i,int turn){
        if (turn%2==0 && (scoreP1+i)<=100 && msg!="----GAME-OVER----"){
            ...
            msg2="";
            if(i==6&& scoreP1==0)//if initially P1 throws 6, he is ready to play/
                scoreP1=scoreP1+1;
            else if(i<=6 && scoreP1>0)
                scoreP1=scoreP1+i;
            ...
            msg1="";
            if(i==6&& scoreP2==0)//if value of dice is 6, now P2 is ready to play
                scoreP2=scoreP2+1;
            else if(i<=6 && scoreP2>0)
                scoreP2=scoreP2+i;
